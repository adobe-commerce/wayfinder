...
Verify current URL via the index if any fail:
...
- **[Adobe Commerce Storefront](./storefront.md)** for Commerce-specific drop-ins, commerce blocks, or storefront boilerplate — do not use AEM/EDS as the only source for these.
- **[Document Authoring](./document-authoring.md)** for da.live-specific authoring, DA permissions, and DA org/site setup.
